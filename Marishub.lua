...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Welcome SUMMER HUB!<Color=/>"):Display()
    wait(.5)
    ...
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: SUMMER HUB<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "SUMMER HUB", HidePremium = false, IntroText = "SUMMER HUB", SaveConfig = true, ConfigFolder = "SUMMER HUB"})
...
W:AddLabel("Join my discord me to 700 member update script")
...
W:AddLabel("[+] Welcome to SUMMER HUB!")
W:AddLabel("[+] Discord: https://discord.com/invite/XV5S956Ymh")
W:AddLabel("[+] Pls Join Discord")
